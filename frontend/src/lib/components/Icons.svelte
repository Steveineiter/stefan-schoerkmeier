<!--Taken from https://stackoverflow.com/questions/66069647/best-way-to-import-svg-icons-into-a-svelte-app -->
<script lang="ts">
    ...
    let icons = {
        ...
        blog: {
            box: 16,
            svg: `<path d="M2 2h12a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zm0 1v10h12V3H2zm2 2h8v1H4V5zm0 3h8v1H4V8zm0 3h5v1H4v-1z"/>`
        }
